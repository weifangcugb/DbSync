...
public class TableBean {
    ...
    public String getSqlString(String prisonId, String clientId, String dbName, String rowVersionColumn, int sqlLimitNum) {
        return "SELECT top " + sqlLimitNum + " '" + prisonId + "' AS hdfs_prison, '" + clientId + "' AS hdfs_client, '" + dbName + "' AS hdfs_db, '" +
