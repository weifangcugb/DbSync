...
//			+ "{\"db\":\"PrasDB\",\"rowversion\":\"starttime\",\"tables\":[{\"table\":\"pras/getResult\",\"starttime\":\"0\"},{\"table\":\"pras/getTable\",\"starttime\":\"0\"}]}]}";
	...
	private static String bangjiaoInitJson2 = "{\"databases\":["
			+ "{\"db\":\"HelpDB\",\"rowversion\":\"ID\",\"tables\":["
			+ "{\"table\":\"Sms_SmsSendBoxes\",\"ID\":\"" + 0 + "\", \"join\":[\"Prisoner\", \"Users\", \"Departments\"],"
				+ "\"key\":\"Sms_SmsSendBoxes.PrisonerFk = Prisoner.UserFk and Prisoner.UserFk = Users.Id "
						+ "and Users.DepartmentFk = Departments.Id\","
				+"\"replaceOp\":[{\"toColumn\":\"FailureReasonFk\",\"fromTable\":\"CommonCodes\",\"fromKey\":\"Id\",\"fromColumns\":\"Code Name\"},"
					...
					+ "{\"toColumn\":\"RelationFk\",\"fromTable\":\"CommonCodes\",\"fromKey\":\"Id\",\"fromColumns\":\"Code Name\"}"
					+ "]"
				+ "}"
			+ ","
			+ "{\"table\":\"Sms_SmsReceiveBoxes\",\"ID\":\"" + 0 + "\", \"join\":[\"Prisoner\", \"Users\", \"Departments\"],"
				+ "\"key\":\"Sms_SmsReceiveBoxes.PrisonerFk = Prisoner.UserFk and Prisoner.UserFk = Users.Id "
					+ "and Users.DepartmentFk = Departments.Id\","
				+ "\"replaceOp\":[{\"toColumn\":\"FailureReasonFk\",\"fromTable\":\"CommonCodes\",\"fromKey\":\"Id\",\"fromColumns\":\"Code Name\"},"
					+ "{\"toColumn\":\"RelationFk\",\"fromTable\":\"CommonCodes\",\"fromKey\":\"Id\",\"fromColumns\":\"Code Name\"}"
