...
public class JWTVerifier {
    ...
    public Map<String, Object> verify(final String token) throws NoSuchAlgorithmException, InvalidKeyException, IllegalStateException,
        ...
        return mapper.convertValue(jwtPayload, Map.class);
    }

    public void verifySignature(final String[] pieces, final Algorithm algorithm) throws NoSuchAlgorithmException,
    ...
    private void verifyHmac(final Algorithm algorithm, final String[] pieces, final byte[] secret) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        System.out.println(decoder.decode(pieces[2]));
...
//        throw new JWTAudienceException("jwt audience invalid", audNode);
    ...
    public String signGenaration() {
    	String issuer = "https://mydomain.com/";
    ...
    public static void main(String []args) throws InvalidKeyException, NoSuchAlgorithmException, IllegalStateException, SignatureException, IOException, JWTVerifyException {
    	final String secret = "x6I0%^sa2u3$";
    	try {
    	    final JWTVerifier verifier = new JWTVerifier(secret);
//    	    String jwt = verifier.signGenaration();
//    	    System.out.println(System.currentTimeMillis() / 1000l);
    	    String jwt = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjEsImlzcyI6ImNvbS5jbG91ZGJlYXZlci50ZXN0Rm9yVG9rZW4iLCJpYXQiOjE0NzEyMzQwOTZ9.kjr9RJ7-e-O_PV2-2A-1NiQI2RpnBmmD8qNV8ehnWFE";
