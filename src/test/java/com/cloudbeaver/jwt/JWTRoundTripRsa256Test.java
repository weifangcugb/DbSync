...
public class JWTRoundTripRsa256Test {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchProviderException, IOException, InvalidKeyException, InvalidKeySpecException, SignatureException, JWTAlgorithmException, JWTVerifyException {
		JWTRoundTripRsa256Test jwtRoundTripRsa256Test = new JWTRoundTripRsa256Test();
		jwtRoundTripRsa256Test.createPemFiles();
		jwtRoundTripRsa256Test.roundTripCreatingSignedTokenAndVerifyingUsingRs256Algo();
	}
